...
Source: /#/http/x-redirect/JTI0bSUyRkNhbGVuZGFyRXZlbnRzUmVzcG9uc2U
...
|  --- | --- | --- | --- |
| `events` | [`array<Calendar Event>`](/llms-pages/http/models/structures/calendar-event.md) | Required | List of calendar action events for the current result set. |

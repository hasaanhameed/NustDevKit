...
Source: /#/http/x-redirect/JTI0bSUyRkNvdXJzZU1vZHVsZQ
...
| `instance` | `Number` | Optional | Instance ID of the activity within its module type. |
| `description` | `String` | Optional | HTML description/intro for the module, when present. |
| `visible` | `Number` | Optional | Whether the module is visible (1) or hidden (0). |
| `uservisible` | `Boolean` | Optional | Whether the module is visible to the current user. |
...
| `contents` | [`array<Course Content File>`](/llms-pages/http/models/structures/course-content-file.md) | Optional | Uploaded files/links for this module (present for resource/folder modules). |

...
Source: /#/go/x-redirect/JTI0bSUyRk5vdGlmaWNhdGlvbg
...
| `Timeread` | `models.Optional[int]` | Optional | Unix timestamp when the notification was read; null if unread. |
...
func main() {
    notification := models.Notification{
        ...
        Timeread:              models.NewOptional(models.ToPointer(102)),
        Read:                  false,
        Deleted:               false,

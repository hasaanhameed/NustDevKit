...
Source: /#/ruby/x-redirect/JTI0bSUyRlBvcHVwTm90aWZpY2F0aW9uc1Jlc3BvbnNl
...
|  --- | --- | --- | --- |
| `notifications` | [`Array[Notification]`](/llms-pages/ruby/models/structures/notification.md) | Required | List of popup notifications for the user. |
| `unreadcount` | `Integer` | Required | Total number of unread notifications for the user. |
...
```ruby
popup_notifications_response = PopupNotificationsResponse.new(
  notifications: [
    Notification.new(
      id: 4857819,
      useridfrom: 234567,

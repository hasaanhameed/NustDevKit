...
Source: /#/java/x-redirect/JTI0aCUyRl9fYWRkaXRpb25hbF9kb2N1bWVudGF0aW9uJTJGQ29uZmlndXJhdGlvbiUyRkh0dHBDbGllbnRDb25maWd1cmF0aW9uLkJ1aWxkZXI

Class to build instances of [HttpClientConfiguration](/llms-pages/java/sdk-infrastructure/configuration/httpclientconfiguration.md).
...
| <code>proxyConfig([HttpProxyConfiguration.Builder](/llms-pages/java/sdk-infrastructure/configuration/httpproxyconfiguration-builder.md) proxyBuilder)</code> | Sets the proxy configuration for the underlying HTTP client. | `HttpClientConfiguration.Builder` |
| `build()` | Builds a new HttpClientConfiguration object using the set fields. | [`HttpClientConfiguration`](/llms-pages/java/sdk-infrastructure/configuration/httpclientconfiguration.md) |
